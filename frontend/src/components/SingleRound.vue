    ...
    <v-card>
        ...
        >
            ...
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <v-text-field
                        :disabled="disabled[props.index]"
                        :ref="'first_throw_'+props.index"
                        class="centered-input"
                        maxlength="2"
                        @input="sumTotal($event, props.index)"
        ...
        sumTotal: function(value, index) {
          ...
          accordingly on each runthrough. */
            ...
            if (this.teamSide == 'home') {
                ...
                throws =
                    this.roundNumber == 1 ? [4, 5, 6, 7] : [12, 13, 14, 15];
            }

            array.forEach(function(item) {
                const element = this.$refs[item + '_throw_' + index].$refs.input
                    .value;
